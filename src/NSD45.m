        ...
        if ischar(varargin{j})
           ...
           switch  lowerCaseArg
               case 'stationary points'
                   ...
                   stationaryPointsCheck(G,gStationaryPoints);
               case 'fsingularities'
        ...
        for branchIndex=1:pathPowers(critPointIndex)
            ...
            if ~FPindices{critPointIndex}(branchIndex)
                ...
                %get weights and nodes
                    [x{critPointIndex, branchIndex}, w{critPointIndex, branchIndex}]=pathQuad( 0, inf, pathPowers(critPointIndex), COVsingularities, min(quadMax,N*pathPowers(critPointIndex)) );
